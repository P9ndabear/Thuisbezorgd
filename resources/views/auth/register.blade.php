...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Pizza Bestellijn') }} - Registreren</title>
    ...
    <body class="font-sans antialiased text-gray-900">
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
                <h2 class="text-2xl font-bold text-center mb-6 text-gray-900 dark:text-gray-100">Registreren</h2>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <x-primary-button class="ml-4 bg-orange-500 hover:bg-orange-600">
                            {{ __('Registreren') }}
                        </x-primary-button>
                    </div>
                </form>
